<%-- 
    Document   : splatBoardShoot
    Created on : Apr 21, 2018, 8:40:08 PM
    Author     : Bgerb
--%>
...
<html >
    ...
    <center> <h1>   Splatter Board Shoot</h1></center>
        <br>
        <center>
            ...
            <div class="form-group">
                ...
                <table class="table table-bordered table-striped " style="width: 70%">
                    ...
                    try
                    {
                     ...
                     String query = "Select name,email,phone from member where splatBoardShoot = 'Yes'";
