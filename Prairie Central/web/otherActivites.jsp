<%-- 
    Document   : otherActivites
    Created on : Apr 21, 2018, 8:51:25 PM
    Author     : Bgerb
--%>
...
<html >
    ...
    <center> <h1>   Other Activities </h1></center>
        <br>
        <center>
            ...
            <div class="form-group">
                ...
                <table class="table table-bordered table-striped " style="width: 70%">
                    ...
                    try
                    {
                     ...
                     String query = "Select name,email,phone from member where other = 'Yes'";
